...
public function AdminiAnswersAcad($facultyId){


		$this->db->select('sum(choice_1) as "total_choice_1",sum(choice_2) as "total_choice_2",sum(choice_3) as "total_choice_3",sum(choice_4) as "total_choice_4",sum(choice_5) as "total_choice_5",sum(choice_6) as "total_choice_6"');

		$this->db->from('evaluation e')->join('administrative_answer pa','e.id = pa.evaluation_id','left');
	...
	public function AdminiAnswersSelf($facultyId){
	...
	public function AdminiAnswers($facultyId){
...
public function GetTotalEvaluatorAcad($facultyId){
	...
	public function GetAll(){
		...
		$this->db->select('0 as profScore,0 as adminiScore,0 as instrucScore, (select count(*) from evaluation where type="Student" and facultyId=f.id) as totalEvaluator,(select count(*) from evaluation where type="Academic" and facultyId=f.id) as totalEvaluatorAcad',false);
	...
	public function find_by_id($id) {
		...
		$this->db->where('id',$id);
			...
			$faculty->adminiAnswers = $this->AdminiAnswersSelf($row->id);
			...
			$faculty->adminiAnswersStudent = $this->AdminiAnswers($row->id);
